...
const CartScreen = () => {
  ...
  //   <div className="h-screen bg-gray-100 pt-20 bg-gradient-to-b from-white via-orange-200 to-white">
  ...
  //             <p className="mt-1 text-xs text-gray-700">₹20</p>
  //           </div>
  ...
  //         </div>
  //       </div>
  //       <motion.button whileTap={{scale:0.9}} className="mt-6 w-full rounded-md bg-orange-500 py-1.5 font-medium text-blue-50 hover:bg-orange-600">Check out</motion.button>
  //     </div>
  //   </div>
  // </div>
  )
